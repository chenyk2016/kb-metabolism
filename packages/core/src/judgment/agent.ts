...
**由主人用自己的话说出最终判断**——你绝不代替合成、绝不改写主人的措辞。
主人说出判断后，用这条命令落盘（唯一合法通道，带 L0 上限检查与 kb_digested 闭环；
禁止用 kb_add 直接建 L0——那会绕过硬上限）：

  kb chew --vault ${vault.root} --judgment "<主人原话>" --use-when "<主人说的用途>" --source <源笔记路径>
